...
class __TwigTemplate_bc9e76995e018054a7fb3718326147f1bc27123bf8aa475dabb3a3753e48ff26 extends Twig_Template
{
...
\t\t";
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute($_loops_, "providers", array()));
...
\t\t\t<legend>";
            ...
            echo $this->getAttribute($_providers_, "NAME", array());
            echo "</legend>
\t\t\t";
            // line 45
            if (isset($context["providers"])) { $_providers_ = $context["providers"]; } else { $_providers_ = null; }
            $context['_parent'] = (array) $context;
            $context['_seq'] = twig_ensure_traversable($this->getAttribute($_providers_, "values", array()));
...
\t\t\t\t<dt>";
                ...
                echo $this->getAttribute($_values_, "KEY", array());
                echo "</dt>
\t\t\t\t<dd>";
                // line 48
                if (isset($context["values"])) { $_values_ = $context["values"]; } else { $_values_ = null; }
                echo $this->getAttribute($_values_, "VALUE", array());
                echo "</dd>
\t\t\t</dl>
\t\t\t";
            }
