...
/* acp_inactive.html */
class __TwigTemplate_9a2345f97bec0fc2a1a33d37f3f4216a43786ebe662b87bd56c3fb072ea5aec0 extends Twig_Template
{
...
\t\t";
            ...
            $this->loadTemplate("pagination.html", "acp_inactive.html", 61)->display($context);
            if ($namespace) {
                $this->env->setNamespaceLookUpOrder($previous_look_up_order);
            }
            // line 62
...
";
        ...
        $this->loadTemplate("overall_footer.html", "acp_inactive.html", 74)->display($context);
        if ($namespace) {
            $this->env->setNamespaceLookUpOrder($previous_look_up_order);
        }
    }
