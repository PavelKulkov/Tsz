...
<soapenv:Body>
    ...
    <smev:Message>
        ...
        <smev:ServiceCode>FundGuardianChildService</smev:ServiceCode>
      ...
      <smev:MessageData>
        <smev:AppData>
          <q1:queryData>
            ...
            <q1:childBirthDay>
			<?php
			$childBirthDay = explode("-",$_POST['childBirthDay']); 
			echo $childBirthDay[2]."-".$childBirthDay[1]."-".$childBirthDay[0];
			?>
			</q1:childBirthDay>
            <q1:childFIO><?php echo $_POST['childFIO']; ?></q1:childFIO>
            <q1:identityChildDocument><?php echo $_POST['identityChildDocument']; ?></q1:identityChildDocument>
			<q1:contacts>
          ...
          <q1:ticketCostsData>
            <q1:flagAlternativeMoney>
			<?php echo ($_POST['flagAlternativeMoney']  == "on") ? 'true' : 'false'; ?></q1:flagAlternativeMoney>
            <q1:schoolName><?php echo $_POST['schoolName']; ?></q1:schoolName>
          </q1:ticketCostsData>
          <q3:inParams>
  			<q3:app_id><?php echo(htmlspecialchars($idRequest));?></q3:app_id> 
  			<q3:form_id>14</q3:form_id>
