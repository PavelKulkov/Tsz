...
<soapenv:Body>
  ...
  <q1:flagSingleMother><?php echo ($_POST['flagSingleMother']  == "on") ? 'true' : 'false'; ?></q1:flagSingleMother> 

  <q1:flagSixteenYearsOld><?php echo ($_POST['flagSixteenYearsOld']  == "on") ? 'true' : 'false'; ?></q1:flagSixteenYearsOld> 

  <q1:flagSoldierChild><?php echo ($_POST['flagSixteenYearsOld']  == "on") ? 'true' : 'false'; ?></q1:flagSoldierChild> 

  <q1:noWayGetAlimony><?php echo $_POST['noWayGetAlimony']; ?></q1:noWayGetAlimony>
