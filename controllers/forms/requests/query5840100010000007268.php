            ...
            <smev:MessageData>
                <smev:AppData>
                    <q1:result>
                        ...
                        <q1:dataRow>
                            <q1:name>categoriesOfCitizens</q1:name>
                            <q1:value><?php echo $_POST['categoriesOfCitizens']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>FIODeath</q1:name>
                            <q1:value><?php echo $_POST['FIODeath']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>contacts_phone</q1:name>
                            <q1:value><?php echo $_POST['phone']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>contacts_eMail</q1:name>
