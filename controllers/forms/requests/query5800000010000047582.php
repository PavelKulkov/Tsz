...
<soapenv:Body>
    <smev:sendQuery>
		...
		<smev:ServiceName>RegistrationInStationaryService</smev:ServiceName> 
        ...
        <smev:ServiceCode>RegistrationInStationaryService</smev:ServiceCode>
      ...
      <smev:MessageData>
        <smev:AppData>
          <q1:queryData>
            ...
            <q1:flagIncompetent><?php echo ($_POST['flagIncompetent']  == "on") ? 'true' : 'false'; ?></q1:flagIncompetent>
