<?php 
	 $subservice_url_id = 76; 
      $soapAction = "urn:getDaysZB";
?>
    ...
    <S:Body wsu:Id="body">
        <ns2:ZagsService xmlns:ns2="http://smev.gosuslugi.ru/rev120315" xmlns:ns3="http://wsService.zags.com/">
            <ns2:Message>
                ...
                <ns2:Date>2012-11-28T09:47:26.272+04:00</ns2:Date>
                ...
                <ns2:AppData>
                    <wsZagsTimeZB>
                        <getDaysZB>
                            ...
                            <dateRange>
                                <minDat><?php echo $_GET['minDat']; ?></minDat>
                                <maxDat><?php echo $_GET['maxDat']; ?></maxDat>
                            </dateRange>
