    ...
    <soapenv:Body>
        <smev:doRequestPhys>
            <smev:Message>
                ...
                <smev:ServiceName>FundResitingActivityService</smev:ServiceName>
            ...
            <smev:MessageData>
                <smev:AppData>
                    <q1:queryData>
                        ...
                        <q1:ownerDwelling><?php echo $_POST['ownerDwelling']; ?></q1:ownerDwelling>
                        <q1:roomAddress><?php echo $_POST['roomAddress']; ?></q1:roomAddress>
                    </q1:queryData>
                    <q1:physDataQuery>
                        ...
                        <q1:flagHaveRightOnAuthorized><?php echo ($_POST['flagHaveRightOnAuthorized']  == "on") ? 'true' : 'false'; ?></q1:flagHaveRightOnAuthorized>
