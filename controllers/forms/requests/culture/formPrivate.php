                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800100010000095487</q1:value>
                        </q1:dataRow>
						<q1:dataRow>
                        ...
                        <q1:dataRow>
                            ...
                            <q1:value><?php echo $_POST['typeInformation_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>purpose</q1:name>
                            <q1:value><?php echo $_POST['purpose_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>name</q1:name>
                            <q1:value><?php echo $_POST['name_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>siteObject</q1:name>
                            <q1:value><?php echo $_POST['siteObject_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
