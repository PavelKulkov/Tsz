function requestParse() {
	...
	function showstyle()
	{
	    ...
	    $('#registrationForm span.print_title').css({'text-align':'center','display':'block','font-weight':'bold'});	
		$('#registrationForm span.print_text').css({'text-align':'left','font-style':'italic','font-weight':'normal'});
		$('#registrationForm span.print_textr').css({'text-align':'right','font-style':'italic','font-weight':'normal'});
		$('#registrationForm span.print_subTitle').css({'text-align':'left','display':'block','font-weight':'bold'});	
		$('#registrationForm span.print_hint').css({'text-align':'center','display':'block','font-size':'12px','padding-bottom':'20px'});
		$('#registrationForm span.print_label').css({'text-align':'left','display':'block','font-weight':'bold'});
		$('#registrationForm span.print_tlabel').css({'text-align':'center','display':'block','font-weight':'bold'});
		
		$('#registrationForm table tr').css('background-color', '#efebde');
		$('fieldset').css({'background-color':'#efebde', 'padding':'10px'});
		
		$('#registrationForm .indent_clear').css({'margin':'0','padding':'0'});
		$('#registrationForm input[type=text]').css('width','100%');
		$('#registrationForm select').css('width','100%');
		$('#registrationForm textarea').css('width','100%');
		$('#registrationForm input.input_w1').css('width','60%');
		$('#registrationForm input.input_w2').css('width','25%');
		$('#registrationForm input.input_w3').css('width','15%');
		$('#registrationForm input.input_w4').css('width','35%');
		$('#registrationForm select.select_w5').css('width','45%');
		$('#registrationForm select.select_w1').css('width','65%');
		$('#registrationForm select.select_w2').css('width','25%');
		$('#registrationForm textarea').css('height','40px');
		$('#registrationForm textarea').attr("resizable",true);
		
		
		

		$('#registrationForm table').css('width','100%');
		$('#registrationForm table.mid').css({'width':'94%','margin':'auto'});
		$('#registrationForm table.mid.right').css({'margin-left':'auto','margin-right':'5px'});
		$('#registrationForm table.mid.right table').css({'width':'98%','margin-right':'auto'});
		$('#registrationForm table.mid2').css({'width':'74%','margin':'auto'});
		$('#registrationForm table.small').css({'width':'50%','margin':'auto'});
			
		$('#registrationForm table tr td.td_ext').css('width', '31%');
		$('#registrationForm table tr td.td_ext2').css('width', '23%');
	        $('#registrationForm table tr td.td_ext3').css('width', '50%');
	        $('#registrationForm table tr td.td_ext4').css('width', '40%');
	        $('#registrationForm table tr td.td_ext5').css('width', '15%');
			$('#registrationForm table tr td.td_ext6').css('width', '65%');

		$('#registrationForm fieldset').css({'margin-bottom':'15px', 'margin-left':'30px', 'margin-right':'30px', '-webkit-padding-before': '0.35em','-webkit-padding-start': '0.75em',	'-webkit-padding-end': '0.75em','-webkit-padding-after':'0.625em'});
		$('#registrationForm fieldset.mid').css({ 'width':'80%','margin':'auto'});
		$('#registrationForm fieldset.manual').css({'border':'1px solid #d8d7c7', 'margin-bottom':'15px', 'margin-left':'30px', 'margin-right':'30px', '-webkit-padding-before': '0.35em','-webkit-padding-start': '0.75em',	'-webkit-padding-end': '0.75em','-webkit-padding-after':'0.625em'});
		
		$('#registrationForm span.form_label').css({'text-align':'center','display':'block','color':'#0000ff','font-weight':'bold','font-size':'14px'});

		$('#registrationForm span.title').css({'text-align':'center','display':'block', 'color':'#ff0000','font-weight':'bold'});
		$('#registrationForm legend').css('font-weight','normal');
	    $('#registrationForm legend.group_label').css({'color':'#0000ff', 'font-style':'italic', 'text-align':'left',  'font-size':'13px'});
	    $('#registrationForm legend.group_label.group_hint').css('color','#898989');
	    $('#registrationForm span.label').css({'color':'#000000','font-weight':'bold', 'font-size':'12px'});
	    $('#registrationForm span.label.label_hint').css('color','#898989');
		$('#registrationForm span.step_label').css({'text-align':'left','display':'block','color':'#0000ff'});
	    $('#registrationForm span.hint').css({'color':'#898989','font-style':'italic','font-size':'11px', 'margin-left':'25px', 'padding-bottom':'20px'});
	    $('#registrationForm span.hint.no_indent').css({'margin':'0','padding':'0'});
	    $('#registrationForm  #tabbs').css({'position':'relative', 'padding':'20px', 'margin':'0 auto', 'background-color':'#fff', 'width':'98%', 'min-width':'1006px'});
	    $('#registrationForm .content').css({'border-left':'1px solid #ddd','border-right':'1px solid #ddd', 'width':'100%', 'margin-left':'0px'});
	    $('#registrationForm .content div').css({'padding':'7px 20px 20px 13px', 'color':'black'});
	    $('#registrationForm .clone_text').css('width','355px');
	    $('#registrationForm .field-requiredMarker').css({'color':'#f00', 'font-style':'italic'});
	...
	var text_html='<br/><br/><span class="print_label" style="margin: 0 auto;width: 50px;">исх N:&nbsp;<span class="print_text" id="print_num_query"></span></span><br/>'+
	...
	text_html+='		<span class="print_label" id="serviceName">Наименование услуги&nbsp;<span class="print_text" id="print_name_serv"></span></span>'+		
	( $("#step_1_subservices").val()=="" ? "":'		<span class="print_label" id="subserviceName">Подуслуга&nbsp;<span class="print_text" id="print_sub_serv"></span></span>');
