                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000061503</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>licenceCategory</q1:name>
                            <q1:value><?php echo $_POST['licenceCategory']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>theDesiredCategory</q1:name>
                            <q1:value><?php echo $_POST['theDesiredCategory']; ?></q1:value>
                        </q1:dataRow>
 
                        <q1:dataRow>
                            <q1:name>expirationDateTo</q1:name>
                            <?php $expirationDateTo = str_replace('-', '/', $_POST['expirationDateTo']); ?>
                            <q1:value><?php echo $expirationDateTo; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>experienceInThisPosition</q1:name>
                            <q1:value><?php echo $_POST['experienceInThisPosition']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>seniorityInTheInstitution</q1:name>
                            <q1:value><?php echo $_POST['seniorityInTheInstitution']; ?></q1:value>
                        </q1:dataRow>
                            <q1:dataRow>
