                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000042425</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                         ...
                         <q1:dataRow>
                            <q1:name>documentApostille</q1:name>
                            <q1:value><?php echo $_POST['documentApostille']; ?></q1:value>
                        </q1:dataRow>
                         <q1:dataRow>
                            <q1:name>theDocumentTitle</q1:name>
                            <q1:value><?php echo $_POST['theDocumentTitle']; ?></q1:value>
                        </q1:dataRow>
                         <q1:dataRow>
                            <q1:name>issuedBy</q1:name>
                            <q1:value><?php echo $_POST['issuedBy']; ?></q1:value>
                        </q1:dataRow>
                         <q1:dataRow>
                            <q1:name>detailsDocument</q1:name>
                            <q1:value><?php echo $_POST['detailsDocument ']; ?></q1:value>
                        </q1:dataRow>                         
                        <q1:dataRow>
                            <q1:name>flagConformityOfDocuments</q1:name>
                            <q1:value><?php echo ($_POST['flagConformityOfDocuments'] == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                         <q1:dataRow>
                            <q1:name>documentSurnameScan</q1:name>
                            <q1:value><?php echo $_POST['documentSurnameScanCount']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
