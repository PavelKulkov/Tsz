                    ...
                    <wsZagsPovtPI>
                        <putZjvPovtPI>
                            ...
                            <zjv>
                                ...
                                <docPI>
                                    <num><?php echo $_POST['pi_akt_num']; ?></num>
									  <dat>
											<?php $docRB = explode("-",$_POST['pi_akt_date']); ?>
											<dtDay><?php echo $docRB[0]; ?></dtDay>
											<dtMonth><?php echo $docRB[1]; ?></dtMonth>
											<dtYear><?php echo $docRB[2]; ?></dtYear>
									  </dat>
                                    <zgs><?php echo $_POST['pi_akt_zags']; ?></zgs>
                                    <fioDo>
                                        <fam><?php echo $_POST['pi_akt_num']; ?></fam>
                                        <nam><?php echo $_POST['pi_akt_num']; ?></nam>
                                        <otch><?php echo $_POST['pi_akt_num']; ?></otch>
                                    </fioDo>
                                    <fioPosle>
                                        <fam><?php echo $_POST['pi_akt_num']; ?></fam>
                                        <nam><?php echo $_POST['pi_akt_num']; ?></nam>
