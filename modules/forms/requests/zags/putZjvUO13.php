                    ...
                    <wsZagsUo>
                        <putZjvUO13>
                            ...
                            <zjv>
								...
								$decisionDate = explode("-",$_POST['decision_date']);
								
								echo "
								
								<reshen>
									<reshen>".$_POST['court_name']."</reshen>
									<datResh>".$decisionDate[2]."-".$decisionDate[1]."-".$decisionDate[0]."T00:00:00.000+04:00</datResh>
									<priznan>".$_POST['decision_type']."</priznan>
								</reshen>";
								...
								if (!empty($_POST['death_doc_num'])) {
								
								$deathDocDate = explode("-",$_POST['death_doc_date']);
								
								echo "
								
                                <docSm>
                                    <num>".$_POST['death_doc_num']."</num>
                                    <dat>
                                        <dtDay>".$deathDocDate[0]."</dtDay>
                                        <dtMonth>".$deathDocDate[1]."</dtMonth>
                                        <dtYear>".$deathDocDate[2]."</dtYear>
                                    </dat>
                                    <zgs>".$_POST['death_doc_source']."</zgs>
                                </docSm>";
								...
								if (!empty($_POST['certificate_num'])) {
								
								$certificateDate = explode("-",$_POST['certificate_date']);
								
								echo "
								
								<spravka>
								<num>".$_POST['certificate_num']."</num>
									<dat>
										<dtDay>".$certificateDate[0]."</dtDay>
										<dtMonth>".$certificateDate[1]."</dtMonth>
										<dtYear>".$certificateDate[2]."</dtYear>
									</dat>
									<zgs>".$_POST['certificate_source']."</zgs>
								</spravka>";
