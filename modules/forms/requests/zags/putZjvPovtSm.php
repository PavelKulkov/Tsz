                    ...
                    <wsZagsPovtSm>
                        <putZjvPovtSm>
                            ...
                            <zjv>
                                ...
                                <docSm>
                                    <num><?php echo $_POST['sm_akt_num']; ?></num>
									  <dat>
											<?php $docRB = explode("-",$_POST['sm_akt_date']); ?>
											<dtDay><?php echo $docRB[0]; ?></dtDay>
											<dtMonth><?php echo $docRB[1]; ?></dtMonth>
											<dtYear><?php echo $docRB[2]; ?></dtYear>
									  </dat>
                                    <zgs><?php echo $_POST['sm_akt_zags']; ?></zgs>
                                    <fio>
                                        <fam><?php echo $_POST['dead_last_name']; ?></fam>
                                        <nam><?php echo $_POST['dead_first_name']; ?></nam>
                                        <otch><?php echo $_POST['dead_middle_name']; ?></otch>
                                    </fio>
                                    <datSm>
									  <dat>
											<?php $datSm = explode("-",$_POST['dead_date']); ?>
									  ...
									  <mestoSm>
										<?php
											$country = $_POST['dead_country'];
											 if ($_POST['dead_state_hand_input'] == "on"){
												$state = $_POST['dead_state'];
												$region = $_POST['dead_region'];
												$settlement = $_POST['dead_settlement'];
												$settlement_type = $_POST['dead_settlement_type'];
											 }else{
												$state = $_POST['dead_region_kladr'];
												$region = $_POST['dead_settlementParent_kladr'];
												$settlement = $_POST['dead_settlement_kladr'];
												$settlement_type = "";
											 }
											 $city = $_POST['dead_place'];
										?>
