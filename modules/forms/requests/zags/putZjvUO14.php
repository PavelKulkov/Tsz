                    ...
                    <wsZagsUo>
                        <putZjvUO14>
                            ...
                            <zjv>
								...
								$decisionLawDate = explode("-",$_POST['decision_law_date']);
								
								if (!empty($_POST['name_law'])) {
								
								echo "
								<reshen>
                                    <reshen>".$_POST['name_law']."</reshen>
									<datResh>".$decisionLawDate[2]."-".$decisionLawDate[1]."-".$decisionLawDate[0]."T00:00:00.000+04:00</datResh>
                                    <reshenie>".$_POST['decision_law_type']."</reshenie>
                                </reshen>";
								}
								
								?>
								
                                <zjvl><?php echo $_POST['declarant_type']; ?></zjvl>
								<?php 
								
									if ($_POST['declarant_type'] == "ZJVL_PERSON"){
										
										$zjvlDocumDate = explode("-",$_POST['declarant_type_doc_date']);
										
										$zjvlPerson = "<zjvlPerson>";
											$zjvlPerson .= "<fio>";
												$zjvlPerson .= "<fam>".$_POST['declarant_type_lastname']."</fam>";
												$zjvlPerson .= "<nam>".$_POST['declarant_type_firstname']."</nam>";
												$zjvlPerson .= "<otch>".$_POST['declarant_type_middlename']."</otch>";
											$zjvlPerson .= "</fio>";
											...
											$zjvlPerson .= "</mestoLive>";
											  ...
											  $zjvlPerson .= "<docum>";
												$zjvlPerson .= "<nam>".$_POST['declarant_type_docs']."</nam>";
												$zjvlPerson .= "<seria>".$_POST['declarant_type_doc_ser']."</seria>";
												$zjvlPerson .= "<num>".$_POST['declarant_type_doc_number']."</num>";
												$zjvlPerson .= "<dat>";
													$zjvlPerson .= "<dtDay>".$zjvlDocumDate[0]."</dtDay>";
													$zjvlPerson .= "<dtMonth>".$zjvlDocumDate[1]."</dtMonth>";
													$zjvlPerson .= "<dtYear>".$zjvlDocumDate[2]."</dtYear>";
												$zjvlPerson .= "</dat>";
												$zjvlPerson .= "<ovd>".$_POST['declarant_type_doc_place']."</ovd>";
											  $zjvlPerson .= "</docum>";
