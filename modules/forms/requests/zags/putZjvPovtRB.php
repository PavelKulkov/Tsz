                    ...
                    <wsZagsPovtRB>
                        <putZjvPovtRB>
                            ...
                            <zjv>
                                ...
                                <docRB>
                                    <num><?php echo $_POST['rb_akt_num']; ?></num>
									  <dat>
											<?php $docRB = explode("-",$_POST['rb_akt_date']); ?>
											<dtDay><?php echo $docRB[0]; ?></dtDay>
											<dtMonth><?php echo $docRB[1]; ?></dtMonth>
											<dtYear><?php echo $docRB[2]; ?></dtYear>
									  </dat>
                                    <zgs><?php echo $_POST['rb_akt_zags']; ?></zgs>
                                    <heDo>
                                        <fam><?php echo $_POST['husband_before_rb_last_name']; ?></fam>
                                        <nam><?php echo $_POST['husband_before_rb_first_name']; ?></nam>
                                        <otch><?php echo $_POST['husband_before_rb_middle_name']; ?></otch>
                                    </heDo>
                                    <sheDo>
                                        <fam><?php echo $_POST['wife_before_rb_last_name']; ?></fam>
                                        <nam><?php echo $_POST['wife_before_rb_first_name']; ?></nam>
                                        <otch><?php echo $_POST['wife_before_rb_middle_name']; ?></otch>
                                    </sheDo>
                                </docRB> 
                            </zjv>
                        </putZjvPovtRB>
