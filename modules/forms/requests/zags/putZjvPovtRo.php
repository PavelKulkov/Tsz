                            ...
                            <zjv>
                                ...
                                <docRo>
                                    <num><?php echo $_POST['birth_akt_num']; ?></num>
									  <dat>
											<?php $docRoDate = explode("-",$_POST['birth_akt_date']); ?>
											<dtDay><?php echo $docRoDate[0]; ?></dtDay>
											<dtMonth><?php echo $docRoDate[1]; ?></dtMonth>
											<dtYear><?php echo $docRoDate[2]; ?></dtYear>
									  </dat>
                                    <zgs><?php echo $_POST['birth_akt_zags']; ?></zgs>
                                    <child>
                                    ...
                                    <childDatRojd>
										<?php $childDatRojd = explode("-",$_POST['child_ident_birth_date']); ?>
										<dtDay><?php echo $childDatRojd[0]; ?></dtDay>
										<dtMonth><?php echo $childDatRojd[1]; ?></dtMonth>
										<dtYear><?php echo $childDatRojd[2]; ?></dtYear>
                                    </childDatRojd>
									  <childMestoRojd>
										<?php
