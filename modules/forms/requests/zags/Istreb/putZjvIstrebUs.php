          ...
          <wsZagsIstreb>
            <putZjvIstrebUs>
              ...
              <zjv>
                ...
                <childDoUs>
                  <fio>
                    <fam><?php echo $_POST['fam_u']; ?></fam>
                    <nam><?php echo $_POST['name_u']; ?></nam>
                    <otch><?php echo $_POST['otch_u']; ?></otch>
                  </fio>
                  <datRojdN>
                    <?php 
	                	if ($_POST['date_true_us'] == 'true'){
	                       	$datRojdN = explode("-",$_POST['birthday_u']);
	                    }else{
	                       	$datRojdN = explode("-",$_POST['birthday_s_u']);
	                    }
                    ?>
                  ...
                  <datRojdK>
					<?php $datRojdK = explode("-",$_POST['birthday_po_u']); ?>
                  ...
                  <mestoRojd>
                  <?php
                  		$country = $_POST['gos_us'];
                  		 if ($_POST['hand_input_us'] == "on"){
                  		 	$state = $_POST['subgos_us'];
	                  		$region = $_POST['rayon_us'];
                  		 	$settlement = $_POST['naspun_us'];
                  		 	$settlement_type = $_POST['typenp_us'];
                  		 }else{
							$state = $_POST['subgos_kladr_us'];
							$region = $_POST['naspunParent_kladr_us'];
							$settlement = $_POST['naspun_kladr_us'];
							$settlement_type = "";
						 }
						 $city = $_POST['gorod_us'];
                  	?>
