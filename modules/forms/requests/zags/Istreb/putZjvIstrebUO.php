          ...
          <wsZagsIstreb>
            <putZjvIstrebUO>
              ...
              <zjv>
                ...
                <childDoUO>
                  <fio>
                    <fam><?php echo $_POST['fam_uo']; ?></fam>
                    <nam><?php echo $_POST['name_uo']; ?></nam>
                    <otch><?php echo $_POST['otch_uo']; ?></otch>
                  </fio>
                  <datRojdN>
                    <?php 
	                	if ($_POST['date_true_uo'] == 'true'){
	                       	$datRojdN = explode("-",$_POST['birthday_uo']);
	                    }else{
	                       	$datRojdN = explode("-",$_POST['birthday_s_uo']);
	                    }
                    ?>
                  ...
                  <datRojdK>
					<?php $datRojdK = explode("-",$_POST['birthday_po_uo']); ?>
                  ...
                  <mestoRojd>
                  <?php
                  		$country = $_POST['gos_uo'];
                  		 if ($_POST['hand_input_uo'] == "on"){
                  		 	$state = $_POST['subgos_uo'];
	                  		$region = $_POST['rayon_uo'];
                  		 	$settlement = $_POST['naspun_uo'];
                  		 	$settlement_type = $_POST['typenp_uo'];
                  		 }else{
							$state = $_POST['subgos_kladr_uo'];
							$region = $_POST['naspunParent_kladr_uo'];
							$settlement = $_POST['naspun_kladr_uo'];
							$settlement_type = "";
						 }
						 $city = $_POST['gorod_uo'];
                  	?>
