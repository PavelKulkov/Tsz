          ...
          <wsZagsIstreb>
            <putZjvIstrebPI>
              ...
              <zjv>
                ...
                <peopDoPI>
                  <fio>
                    <fam><?php echo $_POST['fam_pi']; ?></fam>
                    <nam><?php echo $_POST['name_pi']; ?></nam>
                    <otch><?php echo $_POST['otch_pi']; ?></otch>
                  </fio>
                  <datRojdN>
                    <?php 
	                	if ($_POST['date_true_pi'] == 'true'){
	                       	$datRojdN = explode("-",$_POST['birthday_pi']);
	                    }else{
	                       	$datRojdN = explode("-",$_POST['birthday_s_pi']);
	                    }
                    ?>
                  ...
                  <datRojdK>
					<?php $datRojdK = explode("-",$_POST['birthday_po_pi']); ?>
                  ...
                  <mestoRojd>
                     <?php
                  		$country = $_POST['gos_pi'];
                  		 if ($_POST['hand_input_pi'] == "on"){
                  		 	$state = $_POST['subgos_pi'];
	                  		$region = $_POST['rayon_pi'];
                  		 	$settlement = $_POST['naspun_pi'];
                  		 	$settlement_type = $_POST['typenp_pi'];
                  		 }else{
							$state = $_POST['subgos_kladr_pi'];
							$region = $_POST['naspunParent_kladr_pi'];
							$settlement = $_POST['naspun_kladr_pi'];
							$settlement_type = "";
						 }
						 $city = $_POST['gorod_pi'];
                  	?>
                ...
                <peopPoslePI>
                    <fam><?php echo $_POST['fam_pi_p']; ?></fam>
                    <nam><?php echo $_POST['name_pi_p']; ?></nam>
                    <otch><?php echo $_POST['otch_pi_p']; ?></otch>
                </peopPoslePI>
                <timeQue>
