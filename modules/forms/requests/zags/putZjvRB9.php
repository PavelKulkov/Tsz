          ...
          <wsZagsRb>
            <putZjvRB9>
              ...
              <zjv>
                ...
                <?php 
                	if ($_POST['reason_doc'] == "1"){
						echo "<osnReshenie>";
							echo "<reshen>".$_POST['court_name']."</reshen>";
							$datResh = explode("-",$_POST['decision_date']);
							echo "<datResh>".$datResh[2]."-".$datResh[1]."-".$datResh[0]."T00:00:00.000+03:00</datResh>";
							echo "<blToHis>".$_POST['decision_to_who']."</blToHis>";
							echo "<priznan>".$_POST['decision_type']."</priznan>";
						echo "</osnReshenie>";
					}elseif ($_POST['reason_doc'] == "2"){
						echo "<osnPrigovor>";
							echo "<reshen>".$_POST['priznan_law']."</reshen>";
							$datPrigovor = explode("-",$_POST['priznan_date']);
							echo "<datResh>".$datPrigovor[2]."-".$datPrigovor[1]."-".$datPrigovor[0]."T00:00:00.000+03:00</datResh>";
							echo "<blToHis>".$_POST['priznan_to_who']."</blToHis>";
							echo "<srok>".$_POST['year']." лет(года), ".$_POST['month']." месяца(-цев)"."</srok>";
						echo "</osnPrigovor>";
					}
                ?>
                <timeQue>
