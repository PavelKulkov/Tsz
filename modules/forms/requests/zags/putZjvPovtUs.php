                    ...
                    <wsZagsPovtUs>
                        <putZjvPovtUs>
                            ...
                            <zjv>
                                ...
                                <docUs>
                                    <num><?php echo $_POST['us_akt_num']; ?></num>
									  <dat>
											<?php $docRB = explode("-",$_POST['us_akt_date']); ?>
											<dtDay><?php echo $docRB[0]; ?></dtDay>
											<dtMonth><?php echo $docRB[1]; ?></dtMonth>
											<dtYear><?php echo $docRB[2]; ?></dtYear>
									  </dat>
                                    <zgs><?php echo $_POST['us_akt_zags']; ?></zgs>
                                    <childDo>
                                        <fam><?php echo $_POST['child_to_adoption_last_name']; ?></fam>
                                        <nam><?php echo $_POST['child_to_adoption_first_name']; ?></nam>
                                        <otch><?php echo $_POST['child_to_adoption_middle_name']; ?></otch>
                                    </childDo>
                                    <childPosle>
                                        <fam><?php echo $_POST['child_after_adoption_last_name']; ?></fam>
                                        <nam><?php echo $_POST['child_after_adoption_first_name']; ?></nam>
                                        <otch><?php echo $_POST['child_after_adoption_middle_name']; ?></otch>
                                    </childPosle>
                                    <us1>
                                        <fam><?php echo $_POST['adoptive_father_last_name']; ?></fam>
                                        <nam><?php echo $_POST['adoptive_father_first_name']; ?></nam>
                                        <otch><?php echo $_POST['adoptive_father_middle_name']; ?></otch>
                                    </us1>
                                    <us2>
                                        <fam><?php echo $_POST['stepmother_last_name']; ?></fam>
                                        <nam><?php echo $_POST['stepmother_first_name']; ?></nam>
                                        <otch><?php echo $_POST['stepmother_middle_name']; ?></otch>
                                    </us2>
                                </docUs>
                            </zjv>
                        </putZjvPovtUs>
