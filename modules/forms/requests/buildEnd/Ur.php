    ...
    <soapenv:Body>
        <smev:endCapObjForUr>
            ...
            <smev:MessageData>
                <smev:AppData>
                    <q1:activityQuery>
                        <q1:dangerousObject><?php echo ($_POST['isDangerousObject']  == "on") ? 'true' : 'false'; ?></q1:dangerousObject>
                        <q1:flagHaveRightOnEstate><?php echo ($_POST['flagHaveRightOnEstate']  == "on") ? 'true' : 'false'; ?></q1:flagHaveRightOnEstate>
                        <q1:linearObject><?php echo ($_POST['isLinearObject']  == "on") ? 'true' : 'false'; ?></q1:linearObject>
                        <q1:networkOrganization><?php echo ($_POST['isNetworkOrganization']  == "on") ? 'true' : 'false'; ?></q1:networkOrganization>
