        ...
        <smev:AppData>
          <q1:dataLicenseQuery>
			...
			<?php 
				...
				for ($i=1; $i <= $_POST['countListOfDrugs']; $i++) {
						
				echo '<q1:listOfDrugs>'.$_POST['listOfDrugs_'.$i.''].'</q1:listOfDrugs>';
			...
			<?php 
				...
				for ($i=1; $i <= $_POST['countServiceType']; $i++) {
						
				echo '<q1:serviceType>'.$_POST['serviceType_'.$i.''].'</q1:serviceType>';
