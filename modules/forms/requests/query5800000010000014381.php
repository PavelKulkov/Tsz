                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000014381</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>startDate</q1:name>
                            <?php $start_date = explode('-', $_POST['startDate']);
									$start_date = $start_date[0].'/'.$start_date[1].'/'.$start_date[2];
                            ?>
                            <q1:value><?php echo $start_date; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>endDate</q1:name>
                            <?php $end_date = explode('-', $_POST['endDate']);
									$end_date = $end_date[0].'/'.$end_date[1].'/'.$end_date[2];
                            ?>
                            <q1:value><?php echo $end_date; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>bankDetails</q1:name>
                            <q1:value><?php echo $_POST['bankDetails']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>postOffice</q1:name>
                            <q1:value><?php echo $_POST['postOffice']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>militaryService</q1:name>
                            <q1:value><?php echo isset($_POST['militaryService']) ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>flagPeriodsOfEmployment</q1:name>
                            <q1:value><?php echo isset($_POST['flagPeriodsOfEmployment']) ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>periodsOfEmployment</q1:name>
                            <q1:value><?php echo $_POST['periodsOfEmploymentDoc']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
