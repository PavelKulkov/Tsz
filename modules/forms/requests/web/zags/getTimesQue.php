<?php 
		$subservice_url_id = 78;
      $soapAction = "urn:getTimesQue";
?>
        ...
        <ns2:AppData>
          <wsZagsQue>
            <getTimesQue>
              ...
              <datQue xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xsi:type="xs:dateTime"><?php echo $_GET['dateQue'];?></datQue>
