                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000060443</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>culturalHeritage</q1:name>
                            <q1:value><?php echo $_POST['culturalHeritage']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>propertyDetails</q1:name>
                            <q1:value><?php echo $_POST['propertyDetails']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>purposeOfTheConservationWork</q1:name>
                            <q1:value><?php echo $_POST['purposeOfTheConservationWork']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>jobsAtTheFacility</q1:name>
                            <q1:value><?php echo $_POST['jobsAtTheFacility']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>projectDocumentation</q1:name>
                            <q1:value><?php echo $_POST['projectDocumentation']; ?></q1:value>
                        </q1:dataRow>   
                        <q1:dataRow>
                            <q1:name>representativeCulturalHeritage</q1:name>
                            <q1:value><?php echo ($_POST['representativeCulturalHeritage']  == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
