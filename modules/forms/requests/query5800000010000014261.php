                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000014261</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>flagStillbirth</q1:name>
                            <q1:value><?php echo ($_POST['flagStillbirth']  == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>identityParentDocumentScan</q1:name>
                            <q1:value><?php echo $_POST['identityParentDocumentScan']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>stillbirthDocumentScan</q1:name>
                            <q1:value><?php echo $_POST['stillbirthDocumentScan']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>сertificateOfDeath</q1:name>
                            <q1:value><?php echo $_POST['сertificateOfDeath']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>deathNotWorkingDocumentScan</q1:name>
                            <q1:value><?php echo $_POST['deathNotWorkingDocumentScan']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>flagGuardian</q1:name>
                            <q1:value><?php echo ($_POST['flagGuardian']  == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>guardianDocScan</q1:name>
                            <q1:value><?php echo $_POST['guardianDocScan']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
