                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5840100010000011545</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>cadastrRegistration</q1:name>
                            <q1:value><?php echo ($_POST['cadastrRegistration']  == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
					  ...
					  <?php 
                        ...
                        <q1:dataRow>
                            <q1:name>forestArea_rationaleUseForests_".$i."</q1:name>
                            <q1:value>".$_POST['rationaleUseForests_'.$i.'']."</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>forestArea_termForestManagement_".$i."</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>forestArea_landForestArea_".$i."</q1:name>
                            <q1:value>".$_POST['landForestArea_'.$i.'']."</q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>forestArea_useOfForests_".$i."</q1:name>
                        ...
                        <q1:dataRow>
                            <q1:name>licenseforSubsoil</q1:name>
                            <q1:value><?php echo ($_POST['licenseforSubsoil']  == "on") ? 'true' : 'false'; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>cartographicMaterials</q1:name>
                            <q1:value><?php echo $_POST['cartographicMaterials']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
