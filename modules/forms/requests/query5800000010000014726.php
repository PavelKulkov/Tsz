      ...
      <smev:MessageData>
        <smev:AppData>
          <q1:dataDublicateQuery>
            ...
            <q1:flagSpoiledLicense><?php echo ($_POST['flagSpoiledLicense']  == "on") ? 'true' : 'false'; ?></q1:flagSpoiledLicense>
          </q1:dataDublicateQuery>
          <q3:inParams>
		  <q3:app_id><?php echo(htmlspecialchars($idRequest));?></q3:app_id> 
		  <q3:form_id>17</q3:form_id> 
