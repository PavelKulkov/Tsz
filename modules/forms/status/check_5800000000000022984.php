                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000000000022984</q1:value>
                        </q1:dataRow>
						<q1:dataRow>
						    <q1:name>FIO</q1:name>
                        ...
                        <q1:dataRow>
                            ...
                            <q1:value><?php echo $_POST['applicantIdentityDocument_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            ...
                            <q1:value><?php echo $_POST['OGRN_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>landArea</q1:name>
                            <q1:value><?php echo $_POST['landArea_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>cadastralParcelNumber</q1:name>
                            <q1:value><?php echo $_POST['cadastralParcelNumber_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>categoryLand</q1:name>
                            <q1:value><?php echo $_POST['categoryLand_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>permittedUse</q1:name>
                            <q1:value><?php echo $_POST['permittedUse_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>locationOfTheSite</q1:name>
                            <q1:value><?php echo $_POST['locationOfTheSite_']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
