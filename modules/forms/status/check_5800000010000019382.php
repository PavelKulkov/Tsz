                ...
                <smev:AppData>
                    <q1:result>
                        <q1:dataRow>
                            ...
                            <q1:value>5800000010000019382</q1:value>
                        </q1:dataRow>
						<q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>objectOfExamination</q1:name>
                            <q1:value><?php echo $_POST['objectOfExamination']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                        ...
                        <q1:dataRow>
                            <q1:name>summaryStatementJobs</q1:name>
                            <q1:value><?php echo $_POST['summaryStatementJobs']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>minutesOfCommitteeMeeting</q1:name>
                            <q1:value><?php echo $_POST['minutesOfCommitteeMeeting']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>certificationOfWorking</q1:name>
                            <q1:value><?php echo $_POST['certificationOfWorking']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>nameOfCertificationOrganizations</q1:name>
                            <q1:value><?php echo $_POST['nameOfCertificationOrganizations']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>postalAddress</q1:name>
                            <q1:value><?php echo $_POST['postalAddress']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
                            <q1:name>FIOHead</q1:name>
                            <q1:value><?php echo $_POST['FIOHead']; ?></q1:value>
                        </q1:dataRow>
                        <q1:dataRow>
